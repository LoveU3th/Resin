...
func TestLoadEnvConfig_Defaults(t *testing.T) {
	...
	assertEqual(t, "RequestLogDBMaxMB", cfg.RequestLogDBMaxMB, 100)
...
func TestLoadEnvConfig_InvalidProxyTransportTimeouts(t *testing.T) {
	cases := []struct {
		...
		{"response header timeout", "RESIN_PROXY_TRANSPORT_RESPONSE_HEADER_TIMEOUT", "RESIN_PROXY_TRANSPORT_RESPONSE_HEADER_TIMEOUT"},
